...
base_conhecimento_formacao = [
    ("4-4-2", "Uma formação clássica com quatro defensores, quatro meio-campistas e dois avançados.\nOferece um equilíbrio entre defesa e ataque."),
    ("4-3-3", "Uma formação com quatro defensores, três meio-campistas e três avançados.\nÉ uma formação ofensiva que foca em pressionar o adversário e marcar gols."),
    ("4-2-3-1", "Uma formação com quatro defensores, dois meio-campistas defensivos, três meio-campistas ofensivos e um atacante.\nBusca equilíbrio entre defesa e ataque, com ênfase no meio-campo."),
    ("5-4-1", "Uma formação com cinco defensores, quatro meio-campistas e um atacante.\nÉ uma formação defensiva que visa conter o adversário."),
    ("3-5-2", "Uma formação com três defensores, cinco meio-campistas e dois atacantes.\nProporciona um meio-campo sólido e capacidade de ataque pelo centro.")
]
